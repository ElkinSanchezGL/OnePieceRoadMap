...
>
  ...
  <InputField id="username" label={t('login.username')} value={formData.username} onChange={handleChange} className="bg-red-50" />
  <InputField id="password" label={t('login.password')} type="password" value={formData.password} onChange={handleChange} className="bg-red-50" />
  <InputField id="confirmPassword" label={t('register.repeatPassword')} type="password" value={formData.confirmPassword} onChange={handleChange} className="bg-red-50" />

  {formData.password !== formData.confirmPassword && (
    <p className="text-sm text-red-600 mt-1">{t('login.passwordMismatch')}</p>
  )}
